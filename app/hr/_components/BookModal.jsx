...
const BookModal = (
    ...
    function handleBookHr() {
        ...
        try {
            ...
            setError(err.errors?.[0]?.message || "Đặt lịch thất bại");
        }
    }
        ...
        success ? <Congrats setOpen={() => {
            ...
            <div className="text-center mt-7">
                ...
                <p className="text-base text-[#607361] leading-6 mt-3">
                    Link tham gia buổi phỏng vấn đã được gửi đến{" "}
                    <strong>{email}</strong>. Chúc bạn luyện tập hiệu quả
                    và sẵn sàng cho những cơ hội phía trước.
                </p>
            </div>
            ...
            <div className="w-full">
                <div className="flex justify-between text-base text-[#607361]">
                    ...
                    <span className="text-[#2f3c30] font-bold">
                        {data.date.toLocaleDateString('vi-VN')} {data.time}
                    </span>
                </div>
                <div className="flex justify-between text-base text-[#607361]">
                    <span>Hình thức phỏng vấn</span>
                    <span className="text-[#2f3c30] font-bold">Google Meet</span>
                </div>
            </div>
                        ...
                        <div
                            ...
                            >
                                ...
                                <div className={'space-y-5'}>
                                    ...
                                    <Button
                                        disabled={loading || !data.date || !data.name || !data.cv || !data.email}
                                    ...
                                    >{loading && <Loader2 className="animate-spin w-5 h-5" />} Đặt lịch</Button>
                                </div>
                            </div>
                        </div>
                    </motion.div>
